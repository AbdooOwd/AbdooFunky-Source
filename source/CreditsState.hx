...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Abdoo Mod'],
			['Abdoo',	            'abde',		        'Owner, Programmer, Artist, Animator and Musician',		'https://twitter.com/Shadow_Mario_',   '009966'],
			['Ibra',                'ibahit',           'Artist',                                 				'https://google.com',                  'FF6600'],
			['Sido',                'sido',             'The Cat',                                              'https://google.com',                  '666C88'],
			[''],
			/*['Github Helpers'],
			['Name',                'icon',             'Drew the room background',                             'https://yaLinkGoesHere.com',          'Coloor'],
			[''],*/
			['Contributors'],
			['Souhil',              'souhil',           'Helped me to find Ideas, drew some things',            'https://youtube.com/channel/UCw0HkuSSZtyEP7_Thc_VZuA',                 'ff7f27'],
			[''],
			/*['Social Media'],
			['Youtube',             'youtube',          'AbdooOwd',                                             'https://youtube.com',                  'FF2C21'],
			['Discord',             'discord',          'Discord Server',                                       'https://discord.com/app',              '666699'],
			[''],*/
			['Psych Engine Team'],
	...
	override function update(elapsed:Float)
	{
		...
		//if(creditsStuff[curSelected][0] == 'Abdoo')
		var creditSong:String = creditsStuff[curSelected][0];
