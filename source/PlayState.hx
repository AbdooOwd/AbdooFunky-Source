	...
	override public function create()
	{
		...
		//AMOGUS
				if (FlxG.keys.justPressed.X) {
					FlxG.sound.play(Paths.sound('memz/SUSMOGUS'));
				}
		...
		switch(curStage)
		{
			//Abdoo: This things are mid events, i think ?
			case 'limo':
				resetFastCar();
		...
		//WaterMark
		versionTxt = new FlxText(0, FlxG.height - 24, 0, SONG.song + " - " + CoolUtil.difficultyString() + " | Abdoo Mod " + MainMenuState.abdooFunkVersion + " | Psych Engine " + MainMenuState.psychEngineVersion, 16);
  ...
  public function clearShaderFromCamera(cam:String){
	...
	override public function update(elapsed:Float)
	{
		...
		if (FlxG.keys.justPressed.H) {
			...
			FlxG.sound.play(Paths.sound('Hey/HEY'));
		}
		...
		if(ret != FunkinLua.Function_Stop && !transitioning) {
			...
			if (isStoryMode)
			{
				...
				else
				{
					...
					//eema add da video heere like noosense
					...
					//      Gonna add it in another update
